...
module.exports = function withJavaFiles(config) {
    ...
    public void startMonitoring() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            try {
                ...
                sendEvent("error", "Permission denied: " + e.getMessage());
            }
        }
    }
...
public class MediaDetectionPackage implements ReactPackage {
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
      ...
      // Write NotificationListenerService.java
      fs.writeFileSync(
        path.join(javaPath, 'NotificationListenerService.java'),
        `package com.musicshare.app;
